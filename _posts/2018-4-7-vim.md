...
As always, you can read more [here](https://askubuntu.com/questions/58814/how-do-i-add-environment-variables) :)
...
`~/.bash_profile` can be used instead of ~/.profile, but it is read by bash only, not by any other shell ([source](https://superuser.com/questions/183870/difference-between-bashrc-and-bash-profile)
