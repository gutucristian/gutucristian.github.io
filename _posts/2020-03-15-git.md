...
### To list tracking branches

`git remote -vv`

### To make local branch track a remote (upstream) branch

`git push -u origin master`

This tells the local `master` branch to "track" remote `origin` (remember, `origin` is an alias to the remote).
