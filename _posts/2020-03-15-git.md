...
The idea behind git bisect is to perform a binary search in the commit history to find a particular regression.
...
- Before you "commit" (check in) files to the git repository, you need to first place the files in the git "index"
